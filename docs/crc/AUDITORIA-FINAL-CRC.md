...
| **Causa raiz** | `provedorParaWebhook()` monta o adapter do ambiente; a assinatura precisa da credencial _daquele canal_, e descobrir o canal pelo corpo exigiria confiar no corpo                                                        |
...
- `DATABASE_URL` (a _connection string_ do painel do Supabase) — com ela eu rodo
