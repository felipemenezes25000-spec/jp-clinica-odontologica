...
export const FLUXOS: readonly MiniFluxo[] = [
  ...
  },
  {
    ...
    resumo: "A fila mais cara: o plano já foi apresentado e a conversa parou.",
    acento: "dentalOffice",
    cena: "orcamentos",
    passos: [
      { rotulo: "O orçamento saiu", detalhe: "A avaliação aconteceu e o plano foi apresentado." },
      { rotulo: "Passaram os dias", detalhe: "Sem resposta — nem sim, nem não." },
      { rotulo: "Entra na fila", detalhe: "Junto com os outros, do valor mais alto para o mais baixo." },
      { rotulo: "Pergunta, não cobra", detalhe: "“Ficou alguma dúvida?” — e não “vai fechar?”." },
      { rotulo: "Quem responde", detalhe: "Chega para a equipe com o orçamento já aberto na tela." },
      { rotulo: "Quem não quer", detalhe: "Sai da fila e não é procurado de novo." },
    ],
  },
  {
    chave: "trafego",
    titulo: "O lead do anúncio pago",
    resumo: "Quem clica hoje e é respondido amanhã já contratou em outro lugar.",
    acento: "ia",
    cena: "leadPago",
    passos: [
      { rotulo: "A pessoa clica", detalhe: "No anúncio, e preenche o formulário ou chama no WhatsApp." },
      { rotulo: "Chega em segundos", detalhe: "O contato entra no sistema na hora, não no dia seguinte." },
      { rotulo: "Fica registrado de onde veio", detalhe: "Campanha, anúncio e o que a pessoa buscou." },
      { rotulo: "Primeira resposta", detalhe: "A automação responde, ou chama alguém — a clínica escolhe." },
      { rotulo: "Avaliação marcada", detalhe: "Nos horários que existem de verdade na agenda." },
      { rotulo: "Custo por paciente", detalhe: "Quando a pessoa aparece, dá para saber quanto custou trazê-la." },
    ],
  },
  {
    chave: "agente",
    titulo: "O agente respondendo alguém",
    resumo: "O que ele pode fazer, o que o barra, e quem autoriza cada passo.",
    acento: "ia",
    cena: "agente",
    passos: [
      { rotulo: "Chega uma mensagem", detalhe: "O paciente escreve no WhatsApp, a qualquer hora." },
      { rotulo: "Ele lê o que pode ler", detalhe: "Histórico, agenda e o material que a clínica escreveu." },
      { rotulo: "Escolhe o que fazer", detalhe: "Entre vinte e uma ações possíveis — e nenhuma fora dessa lista." },
      { rotulo: "O sistema autoriza", detalhe: "A permissão é conferida depois da escolha e antes do efeito." },
      { rotulo: "A resposta passa por nove portões", detalhe: "Conteúdo clínico, promessa, horário, repetição — qualquer um barra." },
      { rotulo: "Ou sai, ou vira gente", detalhe: "Barrado, o caso vai para a equipe com o histórico pronto." },
    ],
  },
  {
    chave: "encaixe",
    titulo: "A cadeira que vagou",
    resumo: "Cancelamento de hoje virando consulta de hoje, sem queimar a lista.",
    acento: "jp",
    cena: "encaixes",
    passos: [
      { rotulo: "Alguém cancela", detalhe: "Às 9h da manhã, para a consulta das 14h." },
      { rotulo: "O horário entra na lista", detalhe: "Junto com os vãos que já existiam na agenda." },
      { rotulo: "Três convites", detalhe: "Para quem está esperando vaga e cabe naquele horário." },
      { rotulo: "Espera", detalhe: "Se ninguém responder, saem mais três. Nunca a lista inteira." },
      { rotulo: "Cadeira ocupada", detalhe: "A consulta é criada e o horário sai da lista." },
    ],
  },
  {
    chave: "escalonamento",
