...
/**
 * CENA 25 — Cobrança de parcela em atraso.
 *
...
export function Cena25Cobranca() {
        ...
        <Crescer em={4} dur={34} deEscala={0.96}>
          <Fone altura={752}>
            ...
            <Conversa>
              ...
              {/* A política de pagamento, e não um link: gerar cobrança depende
                  de provedor, que a clínica ainda não contratou. O que existe
                  hoje é o limite que ela cadastrou — e a automação o respeita. */}
              <CartaoNaConversa titulo="Como a clínica combinou" em={192}>
