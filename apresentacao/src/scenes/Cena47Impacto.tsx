...
export function Cena47Impacto() {
  ...
  return (
    <Palco>
      <SeloDeCena />
      <TituloDeCena
        kicker="O caminho até a receita"
      ...
      <Em x={320} y={296} zIndex={8}>
        <Escada etapas={IMPACTO.cadeia} em={26} largura={1280} altura={352} />
      </Em>

      <Em x={960} y={764} ancora="topo-centro" largura={1180} zIndex={9}>
        <div
          style={{
