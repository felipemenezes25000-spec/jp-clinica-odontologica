...
export function CapaVaga({ area }: { area: string }) {
  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 z-0 hidden lg:block">
      ...
      <div className="absolute inset-0 bg-[linear-gradient(90deg,var(--brand-deep)_0%,var(--brand-deep)_32%,color-mix(in_oklab,var(--brand-deep)_62%,transparent)_50%,color-mix(in_oklab,var(--brand-deep)_16%,transparent)_74%,transparent_100%)]" />
