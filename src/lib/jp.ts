...
export const AVALIACOES = {
  nota: 4.6,
  total: 195,
  /** Conferido na ficha do Google em 19/09/2026. */
  conferidoEm: "2026-09-19",
};
...
export const TRATAMENTOS: Tratamento[] = [
  {
    ...
    short: "Limpeza",
    headline: "para manter a prevenção em dia.",
  ...
  },
  {
    ...
    titulo: "Restaurações",
    short: "Restaurações",
    headline: "para recuperar forma e função.",
  ...
  },
  {
    ...
    short: "Implantes",
    headline: "para voltar a mastigar com tranquilidade.",
